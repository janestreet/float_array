...
module type S = sig
  ...
  val create_local : len:int -> float_elt -> t
...
module type Permissioned = sig
  ...
  val get : [> read ] t -> int -> float_elt
  external set : [> write ] t -> int -> float -> unit = "%floatarray_safe_set"
  val unsafe_get : [> read ] t -> int -> float_elt
  external unsafe_set : [> write ] t -> int -> float -> unit = "%floatarray_unsafe_set"
